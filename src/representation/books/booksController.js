...
var bookService_1 = require("../../application/services/bookService");
var express_1 = require("express");
var BooksController = /** @class */ (function () {
    function BooksController(bookService) {
        if (bookService === void 0) { bookService = new bookService_1.BookService(); }
        var _this = this;
        ...
        this.router.get('/:id', function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.bookService.getBookById(Number(req.params.id))];
                    case 1:
                        data = _a.sent();
